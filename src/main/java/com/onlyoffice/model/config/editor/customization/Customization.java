...
public class Customization {
     ...
     * please use the {@link Permissions#chat document.permissions.chat} parameter instead.
     */
    @Deprecated
     ...
     * Deprecated since version 6.3, please use the {@link Permissions#editCommentAuthorOnly document.permissions.editCommentAuthorOnly}
     * and {@link Permissions#deleteCommentAuthorOnly document.permissions.deleteCommentAuthorOnly} fields instead.
     */
    @Deprecated
     ...
     * the corresponding commenting functionality will be available for viewing only, adding and editing comments will be unavailable.
     * The default value is "true".
     */
    ...
    /**
     * Adds the request for the file force saving to the {@link Callback callback handler}
    ...
    /**
     * Defines if the editor rulers are displayed or hidden. This parameter is available for the document and presentation editors.
     ...
     * If "false", a hint indicates that the user will receive only a notification of the mention. The default value is "true".
     */
     ...
     * The default value is "false". Deprecated since version 7.0. Please use the {@link Review review.showReviewChanges} parameter instead.
     */
    @Deprecated
     ...
     * The default value is "true". Deprecated since version 7.1. Please use the {@link Features features.spellcheck} parameter instead.
     */
    @Deprecated
     ...
     * Deprecated since version 7.0. Please use the {@link Review review.trackChanges} parameter instead.
     */
    @Deprecated
     ...
     * or to "-2" (fitting the document page width to the editor page). The default value is "100".
     */
