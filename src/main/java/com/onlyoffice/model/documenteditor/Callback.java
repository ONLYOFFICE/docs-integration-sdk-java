...
public class Callback {
     ...
     *
     * @see <a target="_top" href="https://api.onlyoffice.com/docs/docs-api/usage-api/methods/#sethistorydata">"setHistoryData"
     ...
     *
     * @see <a target="_top" href="https://api.onlyoffice.com/docs/docs-api/get-started/how-it-works/saving-file/#saving-in-original-format">
