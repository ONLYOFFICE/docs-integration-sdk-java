...
public class OnlyofficeSaveCallbackHandlerBase implements OnlyofficeCallbackHandler {
     ...
     */
    public OnlyofficeSaveCallbackHandlerBase(OnlyofficeCallbackRegistry registry, OnlyofficeCallbackUploaderRunner callbackUploaderRunner) {
